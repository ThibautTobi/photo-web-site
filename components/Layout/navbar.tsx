...
export default function Navbar () {
    ...
    // import role context sans next auth
    // const { user } = useRole();


/****************************************************************************gestion deconnexion ave un Context */
...
/****************************************************** utilisation de signOut de next Auth pour se deconnecter */
    ...
    return(
        <>
            ...
            {/*  avec utilisation de Context pour changer Login en Logout et aussi géré la deconexion  */}
