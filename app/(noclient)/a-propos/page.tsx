        ...
        <>
            ...
            <div className="container mx-auto text-center">
                ...
                <section className="py-8">
                    ...
                    <Link href="/portfolio" className="bg-black text-white py-2 px-4 inline-block mt-4">
                        Voir le Portfolio
                    </Link>
                </section>
                <section className="py-8">
                    ...
                    <Link href="/services" className="bg-black text-white py-2 px-4 inline-block mt-4">
                        En savoir plus
                    </Link>
                </section>
            </div>
